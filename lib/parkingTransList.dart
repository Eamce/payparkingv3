                ...
                child: listStat == true
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          final diffInHours =
                              dateTimeNow.difference(dateTimeIn).inHours;
                          DateTime dateNow =
                          new DateTime(now.year, now.month, now.day);
                          DateTime timeInDateNow = new DateTime(dateTimeIn.year,
                              dateTimeIn.month, dateTimeIn.day);

                          String strTimeInHrs =
                          DateFormat.H().format(dateTimeIn);
                          int intTimeInHrs = int.parse(strTimeInHrs);
                          String strTimeInMin =
                          DateFormat.m().format(dateTimeIn);
                          int intTimeInMin = int.parse(strTimeInMin);
                          String strTimeInDay =
                          DateFormat.d().format(dateTimeIn);
                            ...
                            if (numberOfDays > 2) {
                              ...
                              if (intTimeNowHrs < 8) {
                                ...
                                if (intTimeNowHrs >= 25) //Compare if Time IN is greater than 7pm(cut-off time)...
                                  ...
                                  if (intTimeNowMin > 0) {
                                    print("intTimeNowMin > 0 TRUE wwww");
                                    excessNoOfHoursFirstDay = 19 - intTimeInHrs;
                                    excessNoOfHoursLastDay = (intTimeNowHrs - 7);
                                    //excessNoOfHoursInBetween = (numberOfDays - 1) * 11;
                                    totalNoOfExcessHours =(excessNoOfHoursFirstDay + excessNoOfHoursLastDay) - 2;
                            ...
                            if (intTimeNowHrs >= 25 && intTimeNowMin >= 1) //Compare if Time IN is greater than 7pm(cut-off time)...
                              ...
                              if (excessNoOfHours >= 2) {
                                if (intTimeNowMin > intTimeInMin) {
                                  ...
                                  print("intTimeNowMin >= intTimeInMin FALSE UBOS");
                                  totalNoOfExcessHours = excessNoOfHours - 2;
                                  totalNoOfHours=excessNoOfHours + 2;
                                  totalChargeAmount = totalNoOfExcessHours * strvechicleCharge; //Depende sa no. of wheels
                                  print('sfsfsddasdasfdasfaf');
                                  print('totalNoOfExcessHours = $totalNoOfExcessHours');
                                  print('totalNoOfHours       = $totalNoOfHours');
                                  print('excessNoOfHours      = $excessNoOfHours');
                                }
                                              ...
                                              return CupertinoAlertDialog(
                                                ...
                                                actions: <Widget>[
                                                  ...
                                                  new FlatButton(
                                                    child: new Text("Yes"),
                                                    onPressed: () {
                                                      print('WITHOUT PAY BABAW');
                                                      // print('Penalty Amount: $penaltyAmount');
                                                      // print('Total No. Of Hours: $totalNoOfExcessHours');
                                                      // print('Total Amount: $totalChargeAmount');
                                                      if (trigger == 0) {
                                                      ...
                                                      if (trigger == 1) {
                                                        ...
                                                        passDataToHistoryWithPay(
                                                            ...
                                                            totalNoOfHours,
                                                            '0');
                                                        //    passDataToHistoryWithPay(plateData2[index]["id"],plateData2[index]['uid'],plateData2[index]["checkDigit"],plateData2[index]["plateNumber"],dateTimeIn,DateTime.now(),plateData2[index]["amount"],penalty,plateData2[index]["empId"],plateData2[index]['fname'],widget.empId,widget.empNameFn,plateData2[index]["location"],penaltyAmount,totalChargeAmount,totalNoOfExcessHours);
//                                                    penaltyPrint.sample();
                                                      }
                                                        ...
                                                        Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) => Delinquent(
                                                                  ...
                                                                  penaltyA: penaltyAmount,
                                                                  totCharge: totalChargeAmount,
                                                                  excessHr: totalNoOfExcessHours,
                                                                  lostTicket: 0)),
                                                        );
                                                      }
                                                      if (data.isEmpty) {
                                                ...
                                                actions: <Widget>[
                                                  new FlatButton(
                                                      ...
                                                      onPressed: () {
                                                        Navigator.of(context)
                                                            .pop();
                                                        managerLoginReprint(plateData[index]['uid'],
                                                            plateData[index]["chekDigit"],
                                                            plateData[index]["plateNumber"],
...
//                           crossAxisAlignment: CrossAxisAlignment.center,
                                children: <Widget>[
                                  ListTile(
                                    title: Text(
                                      '$f.Plt No : ${plateData[index]["plateNumber"]}'.toUpperCase(),
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: width / 20),
                                    ),
