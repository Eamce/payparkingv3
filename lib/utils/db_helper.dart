...
//    var res = client.rawQuery("SELECT * FROM tbl_usersLocationUser as userloc INNER JOIN tbl_location as loc ON loc.locationId = userloc.locUserId  INNER JOIN tbl_users as users ON users.empid = userloc.empId WHERE users.empid = '$userId'");
  ...
  Future countTblUser() async {
    ...
    final response = await http.post(
        Constants.dbSource + "/e_parking/app_countDataDownload",
        body: {});
  ...
  Future countTblLocationUser() async {
    var dataUser;
    final response = await http.post(
        Constants.dbSource + "/e_parking/app_countLocationUser",
        body: {});
    dataUser = jsonDecode(response.body);
    return dataUser;
  }
  ...
  Future countTblLocation() async {
    ...
    final response = await http
        .post(Constants.dbSource + "/e_parking/app_countLocation", body: {});
    dataUser = jsonDecode(response.body);
    return dataUser;
  }
  ...
  Future countTblManager() async {
    var dataUser;
    final response = await http
        .post(Constants.dbSource + "/e_parking/app_countTblManager", body: {});
    dataUser = jsonDecode(response.body);
    return dataUser;
  }
  ...
  Future countTblDelinquent() async {
    var dataUser;
    final response = await http.post(
        Constants.dbSource + "/e_parking/app_countTblDelinquent",
        body: {});
    dataUser = jsonDecode(response.body);
    return dataUser;
  }
  Future saveLogInData(empid,emp_name,datelogin,datelogout,status)async{
    await http.post(
        Constants.dbSource + "/e_parking/saveLogInData",body:{
          "emp_id"    :empid.toString(),
  ...
  Future saveLogOutData(dateTimeLogout)async{
    await http.post(Constants.dbSource + "/e_parking/saveLogOutData",body: {
